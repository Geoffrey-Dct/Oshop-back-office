<div class="container my-4">
        ...
        <form action="" method="POST" class="mt-5">
            ...
            <div class="form-group">
                ...
                <input type="text" name="description" class="form-control" id="subtitle" placeholder="Description du produit">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="price" class="form-control" id="price" placeholder="Le prix du produit">
            </div>
            <div class="form-group">
                <label for="rate">Note</label>
                <input type="number" name="rate" class="form-control" id="rate" placeholder="chiffre de 0 à 5">
            </div>
            <div class="form-group">
                <label for="status">Status</label>
                <input type="number" name="status" class="form-control" id="status" placeholder="1 = disponible, 2 = non disponible ">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" value="0" name="category_id" class="form-control" id="category_id" placeholder="Ex:1 (facultatif) ">
            </div>
            <div class="form-group">
